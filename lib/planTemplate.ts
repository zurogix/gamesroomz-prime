...
const planData: Omit<Workstream, "category">[] = [
  ...
  },
  {
    ...
    currentImplementation:"Existing mobile PvP engine is designed around mobile devices; its networking, player model, input and state management are described in the discovery answers.",
